...
const CREDENTIALS = {
  admin: { email: "vaishnaviboopathi127@gmail.com", password: "Vizhaa@12" },
...
export default function App() {
  ...
  const handleHomeEventClick = (eventName) => {
  ...
  if (loggedIn && userRole === "user") {
    return (
      ...
      >
        {activeTab === "home"          && <HomeTab onNavigate={(t) => setActiveTab(t)} onEventClick={handleHomeEventClick} />}
    ...
    <div style={{ fontFamily: "'Raleway', sans-serif", background: "#0a0804", color: "#f5ead6", overflowX: "hidden" }}>
      ...
      <section id="categories" style={{ padding: "6rem 1.5rem", background: "#0d0b07" }}>
        <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
          ...
          {(["Marriage", "Birthday Celebrations", "Family Celebrations"]).map((group) => {
