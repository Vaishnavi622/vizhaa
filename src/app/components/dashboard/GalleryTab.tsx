...
type GTab = "All" | "Wedding Gallery" | "Birthday Gallery" | "Family Function Gallery" | "Videos";
const TABS: GTab[] = ["All", "Wedding Gallery", "Birthday Gallery", "Family Function Gallery", "Videos"];
...
export default function GalleryTab() {
  const [active, setActive] = useState<GTab>("All");
  ...
  const filteredItems: GalleryItem[] = active === "All" ? gallery : gallery.filter(item => item.category === active);
          ...
          {filteredItems.map((photo, i) => {
            ...
            return (
              <motion.div key={photo.id}
                ...
                onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.borderColor = G.goldDim; }}
                ...
                <div style={{
                  ...
                  onMouseEnter={(e) => {
                    (e.currentTarget as HTMLElement).style.background = "rgba(10,8,4,0.5)";
                    const icon = e.currentTarget.querySelector(".icon-wrap") as HTMLElement | null;
                    if (icon) icon.style.opacity = "1";
                  }}
                  onMouseLeave={(e) => {
                    (e.currentTarget as HTMLElement).style.background = "rgba(10,8,4,0)";
                    const icon = e.currentTarget.querySelector(".icon-wrap") as HTMLElement | null;
