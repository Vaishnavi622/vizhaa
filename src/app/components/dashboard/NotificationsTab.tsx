...
type Notif = { id: string; type: "booking" | "offer" | "reminder"; title: string; body: string; time: string; read: boolean };
...
const FILTERS = ["All", "Booking Updates", "Offers & Discounts", "Event Reminders"] as const;
type Filter = typeof FILTERS[number];

export default function NotificationsTab({ onReadChange }: { onReadChange?: () => void }) {
  ...
  const filterMap: Record<Filter, Notif["type"] | null> = {
    "All": null,
