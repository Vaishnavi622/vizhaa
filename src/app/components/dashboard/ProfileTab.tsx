...
type PTab = "My Account" | "Edit Profile" | "Orders Placed Before" | "Payment History" | "Settings";
...
const PTABS: PTab[] = ["My Account", "Edit Profile", "Orders Placed Before", "Payment History", "Settings"];
...
export default function ProfileTab({ userName, onLogout }: { userName: string; onLogout: () => void }) {
  ...
  const [active, setActive] = useState<PTab>("My Account");
    ...
    <div style={{ padding: "2rem" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "220px 1fr", gap: "1.5rem", alignItems: "start" }} className="lg:grid-cols-[220px_1fr]">
        ...
        <Card style={{ overflow: "hidden" }}>
          ...
          {/* Nav items */}
          {[
            { id: "My Account" as PTab, icon: User },
            { id: "Edit Profile" as PTab, icon: Edit3 },
            { id: "Orders Placed Before" as PTab, icon: ShoppingBag },
            { id: "Payment History" as PTab, icon: CreditCard },
            { id: "Settings" as PTab, icon: Settings },
          ].map(({ id, icon: Icon }) => (
