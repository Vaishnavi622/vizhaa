...
interface EditSubServiceModalProps {
  isOpen: boolean;
  onClose: () => void;
  parentService: any; // The full service object
  subService: SubServiceItem | null;
  onSaved: () => void;
}

export const EditSubServiceModal: React.FC<EditSubServiceModalProps> = ({
  isOpen,
  onClose,
  parentService,
  subService,
  ...
  const [form, setForm] = useState<SubServiceItem>({ name: "", desc: "", img: "" });
